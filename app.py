...
if os.path.exists(path_cinzel) and os.path.exists(path_canva):
    ...
    st.markdown(f"""
        ...
        .title-kidung {{ font-family: 'CinzelCustom', serif; color: #6C4118; font-size: 150px; line-height: 1; margin-bottom: 0px; }}
        .subtitle-wo {{ font-family: 'CanvaSansCustom', sans-serif; color: #6C4118; font-size: 42px; letter-spacing: 0px; margin-top: 5px; margin-bottom: -5px; }}
