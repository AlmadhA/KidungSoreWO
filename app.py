...
if os.path.exists(path_cinzel) and os.path.exists(path_canva):
    ...
    st.markdown(f"""
        ...
        .title-kidung {{ font-family: 'CinzelCustom', serif; color: #6C4118; font-size: 100px !important; line-height: 1; margin-bottom: 0px; }}
        .subtitle-wo {{ font-family: 'CanvaSansCustom', sans-serif; color: #6C4118; font-size: 36px !important; letter-spacing: 0px; margin-top: 5px; margin-bottom: -5px; }}
